\section{Lecture 1: Analytic Geometry, Condensed Mathematics, and Analytic Rings}
\label{lec:1}
...
\begin{equation}
\label{eq:1:condensed-equalizer}
...
\begin{equation}
\label{eq:1:top-functor-of-points}
