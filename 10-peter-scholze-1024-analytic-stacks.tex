...
categories
\begin{equation}
\label{eq:10:tate-banach-equivalence}
...
Tate algebra,
\begin{equation}
\label{eq:10:tate-solidification}
...
\begin{equation}
\label{eq:10:sheafy-iff}
(A,A^{+})\ \text{sheafy}\quad\Longleftrightarrow\quad \Ohub=\mathcal O
\quad\Longleftrightarrow\quad
\forall\,U\ \text{rational},\ \mathcal O(U)\ \text{sits in degree }0\ \text{and is quasiseparated}.
\end{equation}
