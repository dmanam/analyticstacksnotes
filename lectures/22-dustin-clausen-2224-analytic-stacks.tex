\section{Toward Berkovich Spaces: Localization over
...
\emph{Lectures on Analytic Geometry} \cite{scholze2020analytic}.
\end{remark}
...
\mathrm{Im}(\mathcal N)\ =\ \Bigl(\MBerk(\mathbb Z) \times^{\mathbb R_{\ge1}}
\mathbb R_{>0}\Bigr)^{+},
\end{equation}
