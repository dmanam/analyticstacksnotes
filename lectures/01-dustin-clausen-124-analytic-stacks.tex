...
\cite{scholze2019condensed}) used arbitrary profinite sets, i.e.\ arbitrary
...
practice. Both $D(\CondAbl)$ and its heart are $\aleph_1$-compactly generated, though not
compactly generated -- a consequence of the light restriction; Clausen thought,
but was not certain, that $D(\CondAbl)$ is not dualizable. Finally, the reason for choosing $\mathbb{E}_\infty$ or animated
