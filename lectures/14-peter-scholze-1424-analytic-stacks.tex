\section{The Gaseous Analytic Ring, Gaseous Real Vector Spaces, and the Tate Elliptic Curve}
\label{lec:14}
...
\begin{remark}[Gaseousness is very weak]
...
``$\alpha$~infinitesimal'' regime of \cref{rmk:12:states-of-matter} -- yet still
...
\cite{scholze2020analytic}: the only structural input there is that the algebras of
