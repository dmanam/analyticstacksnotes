...
first \emph{Condensed Mathematics} notes \cite{scholze2019condensed}: solidity is
...
\emph{Condensed Mathematics} lecture notes \cite{scholze2019condensed}, and it
...
$M\in\CondAbl$ is ``nonarchimedean complete'' if every null sequence in $M$
is (uniquely) summable.
\end{minipage}}
\end{equation}
...
\cite{scholze2019condensed}, the formula $\mathbb{Z}[S]^{\solid}=\varprojlim_{n}
...
definition of solidity in \cite{scholze2019condensed}; note it involves only
