\section{Toward Analytic Stacks: Motivation from Algebraic Geometry}
\label{lec:15}
...
\cite{scholze2020analytic}; the archimedean/Berkovich subtlety is exactly that the
...
\begin{equation*}
\begin{aligned}
q = 0&\ \rightsquigarrow\ \text{uncompleted } \mathbb{Z}\text{-theory},\\
q = 1&\ \rightsquigarrow\ \text{solid theory},\\
