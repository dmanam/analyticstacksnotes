...
\textbf{Axiom 1.} $N(0)\colon\mathrm{Spec}(R)\to[0,\infty]$ factors
...
\textbf{Axiom 2} (compatibility with inversion)\textbf{.} Writing $T$ for the
...
locus where the norm is a finite real number:
\begin{equation*}
\Aan_R\ :=\ N^{-1}\bigl([0,\infty)\bigr)\ \subseteq\ \mathbb P^1_R .
\end{equation*}
\end{definition}

\textbf{Axiom 3} (multiplicativity)\textbf{.} The square
\begin{equation*}
...
\textbf{Axiom 4.} With $D_R\to\mathbb P^1_R$ as above:
\begin{enumerate}
