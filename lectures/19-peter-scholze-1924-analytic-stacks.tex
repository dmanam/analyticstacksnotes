\section{Analytic Stacks: Definition, Examples, and the Tate Elliptic Curve}
\label{lec:19}
...
stacks.\footnotemark
\footnotetext{%
  This is the definition given in the lectures, but it is in fact incorrect (if
  one wishes to obtain a topos). See
  \cite[Definition 4.2.1]{anschütz2026analyticrhamstacksfarguesfontaine}
  and \cite[Fact 1.21]{scholze2026gestalten} for the corrected version.
}
\end{definition}
...
Scheja--Storch \cite{Scheja_1972}; cf.\ 
\cite[Appendix to Lecture X]{clausen2022complex}.}
\end{remark}
...
\begin{enumerate}
\item Produce a ``norm'' morphism of analytic stacks
...
\item (``Algebraisation''.) Show the quotient is a proper
