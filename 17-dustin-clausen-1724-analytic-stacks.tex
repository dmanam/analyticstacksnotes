...
algebra
\begin{equation}
\label{eq:17:complement-algebra}
A\ =\ \mathbb{Z}(\!(T^{-1})\!).
\end{equation}
...
between these:
\begin{equation}
\label{eq:17:base-change-coherence}
