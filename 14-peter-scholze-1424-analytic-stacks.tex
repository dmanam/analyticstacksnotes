...
A[S]\ =\ \Bigl\{\,\mu=\textstyle\sum_{m\in\mathbb{Z}}\mu_m q^m\ \Big|\ \mu_m\in\mathbb{Z}[S]\subseteq\mathbb{Z}[S]^{\solid},\ |\mu_m|\ \text{at most polynomial}\,\Bigr\}\ =\ \bigcup_{k>0,\ n>0}\ \varprojlim_i\ \prod_{m\ge -n}\mathbb{Z}[S_i]_{\le (n+m)^{k}}\,q^{m}.
\end{equation}
\end{enumerate}
...
\begin{equation}
\label{eq:14:hom-P-P}
\iHom_{\mathbb{Z}}\bigl(P,\,\mathbb{Z}[\widehat{q}]\bigr)\ =\ \bigcup_{n>0}\ \varprojlim_m\ \Bigl(\bigl(\mathbb{Z}[\widehat q]/\widehat q^{\,m}\bigr)_{\le n}[y]\Bigr),\qquad
\iHom_{\mathbb{Z}}\bigl(P,\,\mathbb{Z}[\widehat q][S]\bigr)\ =\ \bigcup_{n>0}\ \varprojlim_m\ \Bigl(\bigl((\mathbb{Z}[\widehat q]/\widehat q^{\,m})[S_i]\bigr)_{\le n}[y]\Bigr).
\end{equation}
